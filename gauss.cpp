//Solving Poisson Equation using Gauss Seidel Method.
...
do
{
    ...
    arr[1][2]=(h*h*func(2,2)+(arr[1][1]+u4))*(0.25);
    arr[2][1]=(h*h*func(1,1)+(arr[1][1]+u4))*(0.25);
    arr[2][2]=(h*h*func(2,1)+(arr[2][1]+arr[1][2]))*(0.25);
    count++;
}
